        ...
        <div class="mt-10 sm:mt-0">
            <x-form-section submit="addTeamMember">
                ...
                <x-slot name="description">
                    {{ __('Add a new store member to your store, allowing them to collaborate with you.') }}
                </x-slot>

                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            {{ __('Please provide the email address of the person you would like to add to this store.') }}
                        </div>
                    </div>
