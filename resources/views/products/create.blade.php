<x-app-layout>
    ...
    <div class="p-8">
        ...
        <h1 class="text-lg md:text-2xl mt-4 font-semibold">Add Product to <span
                class="text-xl md:text-3xl font-bold">{{ str_replace('Team', 'Store', $team->name) }}</span>
        </h1>
        <div class="mt-8">
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-4 space-x-3 ps-4">
                    <x-button class="hover:ring focus:ring active:ring min-w-20 min-h-10 inline-flex justify-center">Add
